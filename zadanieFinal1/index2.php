...
$dir = "/home/xkubicao/public_html/SEMESTRALKA/uploads/Kontajner_Pedagogika/";
$files = scandir($dir);
foreach($files as $file) {
  ...
  if(!is_dir($file)){
	...
	foreach($files2 as $file2) {
		if(!is_dir($file2))
		echo "<a href=http://147.175.98.159/SEMESTRALKA/uploads/Kontajner_Pedagogika/".$file."/".$file2.">".$file2."</a><br><br>";
...
$dir = "/home/xkubicao/public_html/SEMESTRALKA/uploads/Kontajner_Doktorandi/";
$files = scandir($dir);
foreach($files as $file) {
  ...
  if(!is_dir($file)){
	...
	foreach($files2 as $file2) {
		if(!is_dir($file2))
		echo "<a href=http://147.175.98.159/SEMESTRALKA/uploads/Kontajner_Doktorandi/".$file."/".$file2.">".$file2."</a><br><br>";
...
$dir = "/home/xkubicao/public_html/SEMESTRALKA/uploads/Kontajner_Publikacie/";
$files = scandir($dir);
foreach($files as $file) {
  ...
  if(!is_dir($file)){
	...
	foreach($files2 as $file2) {
		if(!is_dir($file2))
		echo "<a href=http://147.175.98.159/SEMESTRALKA/uploads/Kontajner_Publikacie/".$file."/".$file2.">".$file2."</a><br><br>";
...
$dir = "/home/xkubicao/public_html/SEMESTRALKA/uploads/Kontajner_Sluzobne_cesty/";
$files = scandir($dir);
foreach($files as $file) {
  ...
  if(!is_dir($file)){
	...
	foreach($files2 as $file2) {
		if(!is_dir($file2))
		echo "<a href=http://147.175.98.159/SEMESTRALKA/uploads/Kontajner_Sluzobne_cesty/".$file."/".$file2.">".$file2."</a><br><br>";
...
/*............Upload.............*/
echo "<form action='upload.php' method='post' enctype='multipart/form-data' id=upload_file>
    Vyber subor:
